...
function BlackBar() {
  const [searchIconColor, setSearchIconColor] = useState("white");
  const handleSearchIconColor = () => {
    ...
    <>
      <BlackBarMainDiv className="BlackBarMainDiv">
        {searchIconColor == "white" ? (
          ...
          <div
            className="back-drop"
            onClick={() => setSearchIconColor("white")}
          ></div>
        )}
        ...
        <Div>
          ...
          <div className="left-side">
            <SearchIconDiv className="check" style={{ position: "relative" }}>
              {/* <Link href="/search"> */}
              <div className="search-container">
                <div className={`search-icon ${searchIconColor}`}>
                  <SearchIcon
                    fontSize="large"
                ...
                >
                  <InputBase
                    ...
                    type="search"
                    id="sas"
                    className="search-field search__inputs input demo"
                    placeholder="e.g Outdoor Kitchen"
                    autoCapitalize="off"
                    autoComplete="off"
                    autoCorrect="off"
                    name="q"
                    onClick={() => handleSearchIconColor()}
                  />
                </form>
              </div>
            </SearchIconDiv>
          ...
          <div className="right-side">
            ...
            <a href="https://shopnewage.com/account/login/">
              <div className="ds-flex">
                <img
