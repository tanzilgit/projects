...
function Sale() {
	return (
		<Div className="sale-header-main ds-flex">
			...
			<div className="ds-flex right-menu hello">
				<div className="menu-separator">
					...
					<div className='right-side-wrapper'>
						...
						<div className="main-col">
							...
							/>
							<MenuCtaHeader text="Racks & Shelving" url="/shelves-and-off-the-floor-storage/" />
							<MenuCtaHeader text="Slatwall & Accessories" url="/slatwall/slatwall-accessories/" />
							<MenuCtaHeader
								text="Outdoor Kitchens"
								url="https://shopnewage.com/collections/outdoor-kitchen/"
							/>
							<MenuCtaHeader
								text="Cooking Appliances"
								url="https://shopnewage.com/collections/all-grilling"
							/>
							<MenuCtaHeader
								text="Bar Cabinets"
								url="https://shopnewage.com/collections/home-bar/"
							/>
							<MenuCtaHeader
								text="Flooring"
								url="https://shopnewage.com/collections/flooring/"
							/>
							<MenuCtaHeader text="Lighting" url="https://shopnewage.com/collections/cabinet-lighting/" />
						</div>
					</div>
