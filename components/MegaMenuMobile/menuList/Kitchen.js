	...
	return (
		<Div>
			...
			>
				...
				Kitchen <div className="spacer"></div>
				{!subMenuToggle && <img src="/assets/mega-menu/right.png" alt="" />}
			</div>
			{subMenuToggle && (
				<div className="sub-menu-list">
					<MobileMenuCTAmain text="Shop All Kitchen" url="/" />
					<MobileMenuCTA text="Build Your Kitchen" url="/" />
					<MobileMenuCTA text="Kitchen Cabinets" url="/" />
				</div>
			)}
		</Div>
	);
